...
struct CompletionDetailView: View {
    ...
    private var diaryActionsSection: some View {
    ...
    private var diaryMapSheet: some View {
        NavigationStack {
    ...
    private var diaryEnrichSheet: some View {
        NavigationStack {
            Form {
                Section("Note") {
    ...
    private var diaryActionToast: some View {
        VStack {
            Spacer()
