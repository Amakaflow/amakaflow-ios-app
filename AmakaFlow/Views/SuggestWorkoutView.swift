...
struct SuggestWorkoutView: View {
    ...
    private var generatingProgressFraction: CGFloat {
        ...
        return CGFloat(generatingStepIndex + 1) / CGFloat(total)
    }
    ...
    private func cycleGeneratingSteps() async {
        ...
        while !Task.isCancelled {
            ...
            generatingStepIndex = (generatingStepIndex + 1) % SuggestWorkoutGeneratingCopy.steps.count
        }
    }
...
#Preview("Generating — real signal") {
    ...
    return SuggestWorkoutView(viewModel: viewModel)
        .environmentObject(WorkoutsViewModel())
}
#endif
